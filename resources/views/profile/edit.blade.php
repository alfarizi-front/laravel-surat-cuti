                    ...
                    <section>
                        ...
                        <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input id="nama" name="nama" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('nama', $user->nama) }}" required autofocus autocomplete="name" />
                                @error('nama')
                            ...
                            <div>
                                ...
                                <input id="nip" name="nip" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('nip', $user->nip) }}" />
                                @error('nip')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
